...
<template>
  <Head :title="$t('Restaurant Orders')" />

  <AuthenticatedLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ $t('Restaurant Orders') }}</h2>
    </template>
    ...
    <div class="py-12">
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900 overflow-x-scroll">
            <header>
              <h2 class="text-lg font-medium text-gray-900">{{ $t('Current Orders') }}</h2>
            </header>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900 overflow-x-scroll">
            <header>
              <h2 class="text-lg font-medium text-gray-900">{{ $t('Past Orders') }}</h2>
            </header>
